...
j=a.json()
assert j['ok'] is True and j['version']=='0.3.33' and j['css_embedded'] is True and j['js_embedded'] is True
...
css=c.get('/static/styles.css?v=0.3.33')
assert css.status_code == 200 and css.headers['content-type'].startswith('text/css')
js=c.get('/static/app.js?v=0.3.33')
assert js.status_code == 200 and "import * as THREE" not in js.text and "import('three')" in js.text
print('LayerVault v0.3.33 frontend asset delivery regression: PASS')
